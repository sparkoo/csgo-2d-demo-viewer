...
type Round_RoundEndReason int32

const (
	Round_StillInProgress Round_RoundEndReason = 0
	Round_TargetBombed    Round_RoundEndReason = 1
	Round_BombDefused     Round_RoundEndReason = 7
	Round_CTWin           Round_RoundEndReason = 8
	Round_TerroristsWin   Round_RoundEndReason = 9
	Round_TargetSaved     Round_RoundEndReason = 12
)

// Enum value maps for Round_RoundEndReason.
var (
	Round_RoundEndReason_name = map[int32]string{
		0:  "StillInProgress",
		1:  "TargetBombed",
		7:  "BombDefused",
		8:  "CTWin",
	...
	Round_RoundEndReason_value = map[string]int32{
		"StillInProgress": 0,
		"TargetBombed":    1,
		"BombDefused":     7,
		"CTWin":           8,
...
func (x Round_RoundEndReason) Enum() *Round_RoundEndReason {
	p := new(Round_RoundEndReason)
	*p = x
	return p
}

func (x Round_RoundEndReason) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (Round_RoundEndReason) Descriptor() protoreflect.EnumDescriptor {
	return file_Message_proto_enumTypes[2].Descriptor()
}

func (Round_RoundEndReason) Type() protoreflect.EnumType {
	return &file_Message_proto_enumTypes[2]
}

func (x Round_RoundEndReason) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use Round_RoundEndReason.Descriptor instead.
func (Round_RoundEndReason) EnumDescriptor() ([]byte, []int) {
...
type Round struct {
	...
	EndReason         Round_RoundEndReason   `protobuf:"varint,9,opt,name=EndReason,proto3,enum=csgo.Round_RoundEndReason" json:"EndReason,omitempty"`
	unknownFields     protoimpl.UnknownFields
	sizeCache         protoimpl.SizeCache
}
...
func (x *Round) GetEndReason() Round_RoundEndReason {
	if x != nil {
		return x.EndReason
	}
	return Round_StillInProgress
}
...
const file_Message_proto_rawDesc = "" +
	...
	"\x06Winner\x18\b \x01(\tR\x06Winner\x128\n" +
	"\tEndReason\x18\t \x01(\x0e2\x1a.csgo.Round.RoundEndReasonR\tEndReason\"w\n" +
	"\x0eRoundEndReason\x12\x13\n" +
	"\x0fStillInProgress\x10\x00\x12\x10\n" +
	"\fTargetBombed\x10\x01\x12\x0f\n" +
	"\vBombDefused\x10\a\x12\t\n" +
	"\x05CTWin\x10\b\x12\x11\n" +
	"\rTerroristsWin\x10\t\x12\x0f\n" +
	"\vTargetSaved\x10\f\"@\n" +
	"\bProgress\x12\x1a\n" +
...
var file_Message_proto_goTypes = []any{
	...
	(Round_RoundEndReason)(0),  // 2: csgo.Round.RoundEndReason
	(Demo_DemoPlatformType)(0), // 3: csgo.Demo.DemoPlatformType
	(*Message)(nil),            // 4: csgo.Message
	(*Player)(nil),             // 5: csgo.Player
	(*TeamUpdate)(nil),         // 6: csgo.TeamUpdate
	(*TickState)(nil),          // 7: csgo.TickState
	(*Init)(nil),               // 8: csgo.Init
	(*Frag)(nil),               // 9: csgo.Frag
	(*Shot)(nil),               // 10: csgo.Shot
	(*Grenade)(nil),            // 11: csgo.Grenade
	(*Bomb)(nil),               // 12: csgo.Bomb
	(*Round)(nil),              // 13: csgo.Round
	(*Progress)(nil),           // 14: csgo.Progress
	(*RoundTime)(nil),          // 15: csgo.RoundTime
	(*Demo)(nil),               // 16: csgo.Demo
}
var file_Message_proto_depIdxs = []int32{
	0,  // 0: csgo.Message.msgType:type_name -> csgo.Message.MessageType
	6,  // 1: csgo.Message.teamUpdate:type_name -> csgo.TeamUpdate
	7,  // 2: csgo.Message.tickState:type_name -> csgo.TickState
	8,  // 3: csgo.Message.init:type_name -> csgo.Init
	13, // 4: csgo.Message.round:type_name -> csgo.Round
	14, // 5: csgo.Message.progress:type_name -> csgo.Progress
	15, // 6: csgo.Message.roundTime:type_name -> csgo.RoundTime
	10, // 7: csgo.Message.shot:type_name -> csgo.Shot
	9,  // 8: csgo.Message.frag:type_name -> csgo.Frag
	16, // 9: csgo.Message.demo:type_name -> csgo.Demo
	11, // 10: csgo.Message.grenadeEvent:type_name -> csgo.Grenade
	5,  // 11: csgo.TickState.Players:type_name -> csgo.Player
	11, // 12: csgo.TickState.Nades:type_name -> csgo.Grenade
	12, // 13: csgo.TickState.Bomb:type_name -> csgo.Bomb
	1,  // 14: csgo.Bomb.state:type_name -> csgo.Bomb.BombState
	4,  // 15: csgo.Round.Ticks:type_name -> csgo.Message
	6,  // 16: csgo.Round.TeamState:type_name -> csgo.TeamUpdate
	2,  // 17: csgo.Round.EndReason:type_name -> csgo.Round.RoundEndReason
	3,  // 18: csgo.Demo.Platform:type_name -> csgo.Demo.DemoPlatformType
