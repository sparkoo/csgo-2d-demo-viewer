...
const file_Message_proto_rawDesc = "" +
	...
	"\x06CTName\x18\x03 \x01(\tR\x06CTName\"\xe8\x02\n" +
	"\x04Frag\x12\x1e\n" +
	"\n" +
	...
	"IsHeadshot\x12\x1e\n" +
	"\n" +
	"IsWallbang\x18\a \x01(\bR\n" +
	"IsWallbang\x12$\n" +
	"\rAssistedFlash\x18\b \x01(\bR\rAssistedFlash\x12$\n" +
	"\rAttackerBlind\x18\t \x01(\bR\rAttackerBlind\x12\x18\n" +
	"\aNoScope\x18\n" +
	" \x01(\bR\aNoScope\x12\"\n" +
	"\fThroughSmoke\x18\v \x01(\bR\fThroughSmoke\"Z\n" +
	"\x04Shot\x12\x1a\n" +
