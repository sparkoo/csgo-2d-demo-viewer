  ...
  render() {
    ...
    for (let gi = 0; gi < 4; gi++) {
      if (
        ...
        gi < this.props.player.grenadesList.length
      ) {
        const active =
          this.props.player.weapon === this.props.player.grenadesList[gi]
            ? "active"
            : "";
        nades.push(
          <div
            key={gi}
            className={`w3-col l1 ${this.props.player.grenadesList[gi]} ${active}`}
          >
            &nbsp;
          </div>
        );
        ...
        nades.push(
          <div key={gi} className={"w3-col l1"}>
            &nbsp;
          </div>
        );
      }
    ...
    return (
      <div className={"playerListItemContainer w3-row"}>
        <div className={"playerListItem w3-row"}>
          ...
          <div
            className={`w3-col l1 bckg playerListVest ${this.props.player.team} ${armor}`}
          >
            &nbsp;
          </div>
          <div
        ...
        <div className="w3-row playerListWeapons">
          ...
          <div
            className={`w3-col l3
                ...
                ${
                  this.props.player.weapon === this.props.player.primary
                    ? "active"
                    : ""
                }`}
          >
          ...
          <div
            className={`w3-col l2
                ...
                ${
                  this.props.player.weapon === this.props.player.secondary
                    ? "active"
                    : ""
                }`}
          >
        ...
        <div className="w3-row">
          ...
          >
            {`${this.props.player.kills ?? 0}/${
              this.props.player.assists ?? 0
            }/${this.props.player.deaths ?? 0}`}
            &nbsp;
          </div>
          <div className="w3-col l4 playerListMoney w3-right-align playerListItemName">
