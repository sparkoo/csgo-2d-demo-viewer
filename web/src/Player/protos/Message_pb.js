  ...
  proto.csgo.Message.toObject = function (includeInstance, msg) {
    var f,
      obj = {
        ...
        teamupdate:
          (f = msg.getTeamupdate()) &&
          proto.csgo.TeamUpdate.toObject(includeInstance, f),
        tickstate:
          (f = msg.getTickstate()) &&
          proto.csgo.TickState.toObject(includeInstance, f),
        init:
          (f = msg.getInit()) && proto.csgo.Init.toObject(includeInstance, f),
        round:
          (f = msg.getRound()) && proto.csgo.Round.toObject(includeInstance, f),
        progress:
          (f = msg.getProgress()) &&
          proto.csgo.Progress.toObject(includeInstance, f),
        roundtime:
          (f = msg.getRoundtime()) &&
          proto.csgo.RoundTime.toObject(includeInstance, f),
        shot:
          (f = msg.getShot()) && proto.csgo.Shot.toObject(includeInstance, f),
        frag:
          (f = msg.getFrag()) && proto.csgo.Frag.toObject(includeInstance, f),
        demo:
          (f = msg.getDemo()) && proto.csgo.Demo.toObject(includeInstance, f),
        grenadeevent:
          (f = msg.getGrenadeevent()) &&
          proto.csgo.Grenade.toObject(includeInstance, f),
...
proto.csgo.Message.deserializeBinaryFromReader = function (msg, reader) {
  while (reader.nextField()) {
    ...
    switch (field) {
      case 1:
        var value = /** @type {!proto.csgo.Message.MessageType} */ (
          reader.readEnum()
        );
      ...
      case 3:
        ...
        reader.readMessage(
          value,
          proto.csgo.TeamUpdate.deserializeBinaryFromReader
        );
      ...
      case 4:
        ...
        reader.readMessage(
          value,
          proto.csgo.TickState.deserializeBinaryFromReader
        );
      ...
      case 7:
        ...
        reader.readMessage(
          value,
          proto.csgo.Progress.deserializeBinaryFromReader
        );
      ...
      case 8:
        ...
        reader.readMessage(
          value,
          proto.csgo.RoundTime.deserializeBinaryFromReader
        );
      ...
      case 12:
        ...
        reader.readMessage(
          value,
          proto.csgo.Grenade.deserializeBinaryFromReader
        );
...
proto.csgo.Message.serializeBinaryToWriter = function (message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(3, f, proto.csgo.TeamUpdate.serializeBinaryToWriter);
  }
  f = message.getTickstate();
  if (f != null) {
    writer.writeMessage(4, f, proto.csgo.TickState.serializeBinaryToWriter);
  }
  f = message.getInit();
  if (f != null) {
    writer.writeMessage(5, f, proto.csgo.Init.serializeBinaryToWriter);
  }
  f = message.getRound();
  if (f != null) {
    writer.writeMessage(6, f, proto.csgo.Round.serializeBinaryToWriter);
  }
  f = message.getProgress();
  if (f != null) {
    writer.writeMessage(7, f, proto.csgo.Progress.serializeBinaryToWriter);
  }
  f = message.getRoundtime();
  if (f != null) {
    writer.writeMessage(8, f, proto.csgo.RoundTime.serializeBinaryToWriter);
  }
  f = message.getShot();
  if (f != null) {
    writer.writeMessage(9, f, proto.csgo.Shot.serializeBinaryToWriter);
  }
  f = message.getFrag();
  if (f != null) {
    writer.writeMessage(10, f, proto.csgo.Frag.serializeBinaryToWriter);
  }
  f = message.getDemo();
  if (f != null) {
    writer.writeMessage(11, f, proto.csgo.Demo.serializeBinaryToWriter);
  }
  f = message.getGrenadeevent();
  if (f != null) {
    writer.writeMessage(12, f, proto.csgo.Grenade.serializeBinaryToWriter);
  }
...
proto.csgo.Message.prototype.getMsgtype = function () {
  return /** @type {!proto.csgo.Message.MessageType} */ (
  ...
  proto.csgo.Player.toObject = function (includeInstance, msg) {
    var f,
      obj = {
        ...
        grenadesList:
          (f = jspb.Message.getRepeatedField(msg, 23)) == null ? undefined : f,
...
proto.csgo.Player.serializeBinaryToWriter = function (message, writer) {
  ...
  if (f.length > 0) {
    writer.writeRepeatedString(23, f);
  }
  f = message.getKills();
  if (f !== 0) {
...
proto.csgo.Player.prototype.getGrenadesList = function () {
  return /** @type {!Array<string>} */ (
    jspb.Message.getRepeatedField(this, 23)
  );
};
 ...
 * @return {!proto.csgo.Player} returns this
 */
proto.csgo.Player.prototype.setKills = function (value) {
  return jspb.Message.setProto3IntField(this, 24, value);
};

/**
 * optional int32 Assists = 25;
 * @return {number}
 */
 ...
 * @return {!proto.csgo.Player} returns this
 */
proto.csgo.Player.prototype.setAssists = function (value) {
  return jspb.Message.setProto3IntField(this, 25, value);
};

/**
 * optional int32 Deaths = 26;
 * @return {number}
 */
 ...
 * @return {!proto.csgo.Player} returns this
 */
proto.csgo.Player.prototype.setDeaths = function (value) {
  ...
  proto.csgo.TickState.toObject = function (includeInstance, msg) {
    var f,
      obj = {
        ...
        nadesList: jspb.Message.toObjectList(
          msg.getNadesList(),
          proto.csgo.Grenade.toObject,
          includeInstance
        ),
        bomb:
          (f = msg.getBomb()) && proto.csgo.Bomb.toObject(includeInstance, f),
      };
  ...
  while (reader.nextField()) {
    ...
    switch (field) {
      case 1:
        ...
        reader.readMessage(
          value,
          proto.csgo.Player.deserializeBinaryFromReader
        );
...
proto.csgo.TickState.serializeBinaryToWriter = function (message, writer) {
  ...
  f = message.getBomb();
  if (f != null) {
    writer.writeMessage(3, f, proto.csgo.Bomb.serializeBinaryToWriter);
  }
};
  ...
  while (reader.nextField()) {
    ...
    switch (field) {
      ...
      case 3:
        ...
        break;
      case 4:
        var value = /** @type {!proto.csgo.Bomb.BombState} */ (
          reader.readEnum()
        );
        msg.setState(value);
        break;
...
proto.csgo.Bomb.prototype.getState = function () {
  return /** @type {!proto.csgo.Bomb.BombState} */ (
  ...
  proto.csgo.Round.toObject = function (includeInstance, msg) {
    var f,
      obj = {
        ...
        ticksList: jspb.Message.toObjectList(
          msg.getTicksList(),
  ...
  while (reader.nextField()) {
    ...
    switch (field) {
      ...
      case 6:
        ...
        reader.readMessage(
          value,
          proto.csgo.Message.deserializeBinaryFromReader
        );
        msg.addTicks(value);
        break;
      case 7:
...
proto.csgo.Round.serializeBinaryToWriter = function (message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(7, f, proto.csgo.TeamUpdate.serializeBinaryToWriter);
  }
  f = message.getWinner();
  if (f.length > 0) {
  ...
  while (reader.nextField()) {
    ...
    switch (field) {
      case 1:
        ...
        break;
      case 2:
        var value = /** @type {!proto.csgo.Demo.DemoPlatformType} */ (
          reader.readEnum()
        );
...
proto.csgo.Demo.prototype.getPlatform = function () {
  return /** @type {!proto.csgo.Demo.DemoPlatformType} */ (
