...
goog.exportSymbol('proto.csgo.Kill', null, global);
 ...
 * @constructor
 */
proto.csgo.Kill = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.csgo.Kill, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.csgo.Kill.displayName = 'proto.csgo.Kill';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
...
proto.csgo.Message.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    kill: (f = msg.getKill()) && proto.csgo.Kill.toObject(includeInstance, f),
...
proto.csgo.Message.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 9:
      ...
      break;
    case 10:
      var value = new proto.csgo.Kill;
      reader.readMessage(value,proto.csgo.Kill.deserializeBinaryFromReader);
      msg.setKill(value);
      break;
    case 11:
...
proto.csgo.Message.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(
      10,
      f,
      proto.csgo.Kill.serializeBinaryToWriter
    );
  }
  f = message.getDemo();
  if (f != null) {
 ...
 * @return {?proto.csgo.Kill}
 */
proto.csgo.Message.prototype.getKill = function() {
  return /** @type{?proto.csgo.Kill} */ (
    jspb.Message.getWrapperField(this, proto.csgo.Kill, 10));
};


/**
 * @param {?proto.csgo.Kill|undefined} value
 * @return {!proto.csgo.Message} returns this
*/
proto.csgo.Message.prototype.setKill = function(value) {
 ...
 * @return {!proto.csgo.Message} returns this
 */
proto.csgo.Message.prototype.clearKill = function() {
 ...
 * @return {boolean}
 */
proto.csgo.Message.prototype.hasKill = function() {
 ...
 * @return {!Object}
 */
proto.csgo.Kill.prototype.toObject = function(opt_includeInstance) {
  return proto.csgo.Kill.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.csgo.Kill} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.csgo.Kill.toObject = function(includeInstance, msg) {
  var f, obj = {
 ...
 * @return {!proto.csgo.Kill}
 */
proto.csgo.Kill.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.csgo.Kill;
  return proto.csgo.Kill.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.csgo.Kill} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.csgo.Kill}
 */
proto.csgo.Kill.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.csgo.Kill.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.csgo.Kill.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.csgo.Kill} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.csgo.Kill.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
 ...
 * @return {number}
 */
proto.csgo.Kill.prototype.getVictimid = function() {
  return /** @type {number} */ (jspb.Message.getFieldWithDefault(this, 1, 0));
};
...
/**
 * @param {number} value
 * @return {!proto.csgo.Kill} returns this
 */
proto.csgo.Kill.prototype.setVictimid = function(value) {
  return jspb.Message.setProto3IntField(this, 1, value);
};
