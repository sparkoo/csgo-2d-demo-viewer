...
// download URL. Injected as a <script src> element by content-script.js.
(function () {
  ...
  // Note: this fetch sequence is equivalent to fetchDemoUrlDirect() in the
  // content script; both exist because neither context can replace the other.
