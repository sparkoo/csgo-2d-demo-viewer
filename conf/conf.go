...
type Conf struct {
	...
	FaceitClientApiKey string `arg:"--faceitClientApiKey, env:FACEIT_CLIENT_APIKEY" help:"Faceit Client API key. Get it at https://developers.faceit.com/docs/auth/api-keys"`
